...
import { fetchCountries, getCountries } from '@/app/services/countries-service';
import { DynamoDBServiceException } from '@aws-sdk/client-dynamodb';

export async function GET() {
    try {
        return process.env.DEBUG === "TRUE" ? NextResponse.json(getCountries()) : NextResponse.json(await fetchCountries());
    } catch (error) {
