...
export default function SourcePreview({sourceLink}: { sourceLink: string }) {
                ...
                <a href={sourceLink} target="_blank">
                    <div className="flex flex-col xl:flex-row xl:items-stretch rounded-xl border-1 border-foreground/50">
                        ...
                        <div className="grow flex flex-col xl:flex-row items-center p-3">
                            <div className="grow">
                                <h1>{sourceDetails.data.title}</h1>
                                <div className="my-2 text-sm text-foreground/50 italic">
...
function SourcePreviewSkeleton() {
    ...
    return (
        <div>
            <div className={`${shimmer} relative overflow-hidden flex flex-col xl:flex-row xl:items-stretch rounded-xl border-1 border-foreground/50`}>
                <div
                ...
                <div className="grow flex flex-col xl:flex-row xlitems-center px-3 py-4">
                    <div className="grow">
                        <div className="h-6 w-[70%] rounded-md bg-gray-300 dark:bg-gray-400/20"/>
                        <div className="h-4 mt-4 rounded-t-sm bg-gray-200 dark:bg-gray-400/10"/>
                        <div className="h-4 rounded-ee-sm bg-gray-200 dark:bg-gray-400/10"/>
                        <div className="h-4 w-[60%] rounded-b-sm bg-gray-200 dark:bg-gray-400/10"/>
                    </div>
                </div>
            </div>
        </div>
