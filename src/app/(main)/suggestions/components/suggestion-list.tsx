                ...
                <ErrorScreen
                    ...
                    <div className="h-full overflow-y-auto">
                        <div className="flex items-center py-1">
                            <label className="w-full flex items-center justify-end text-sm" htmlFor="hideProcessed">Hide
                                recently processed</label>
                            <input
                                type="checkbox"
                                className="relative peer ms-1 appearance-none shrink-0 rounded w-4 h-4 bg-foreground/10 after:content-[''] after:hidden checked:after:inline-block after:w-2 after:h-3.5 after:ms-1 after:mb-1.5 after:rotate-[40deg] after:border-b-3 after:border-r-3 checked:bg-sky-500 after:border-white dark:after:border-black"
                                id="hideProcessed"
                                name="hideProcessed"
