...
export default function Layout({children}: { children: React.ReactNode }) {
    return (
        ...
        <div className="flex h-screen flex-col md:flex-row md:overflow-hidden bg-gray-100 dark:bg-gray-700/5 dark:bg-background">
            ...
            <div className="absolute w-full bottom-0 py-3 flex-none md:hidden bg-white dark:bg-gray-950 dark:bg-neutral-900">
                <Sidebar />
            </div>
        </div>
    );
